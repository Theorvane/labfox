...
@JsonKey(name: 'star_count') int get starCount; String? get visibility;@JsonKey(name: 'default_branch') String? get defaultBranch;@JsonKey(name: 'package_registry_access_level') String? get packageRegistryAccessLevel;// Null when GitLab omits the count on a reduced payload — unknown, not
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,pathWithNamespace,description,starCount,visibility,defaultBranch,packageRegistryAccessLevel,openIssuesCount,forksCount,avatarUrl,webUrl,lastActivityAt);

@override
String toString() {
  return 'Project(id: $id, name: $name, pathWithNamespace: $pathWithNamespace, description: $description, starCount: $starCount, visibility: $visibility, defaultBranch: $defaultBranch, packageRegistryAccessLevel: $packageRegistryAccessLevel, openIssuesCount: $openIssuesCount, forksCount: $forksCount, avatarUrl: $avatarUrl, webUrl: $webUrl, lastActivityAt: $lastActivityAt)';
}
...
/// Create a copy of Project
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? pathWithNamespace = null,Object? description = freezed,Object? starCount = null,Object? visibility = freezed,Object? defaultBranch = freezed,Object? packageRegistryAccessLevel = freezed,Object? openIssuesCount = freezed,Object? forksCount = freezed,Object? avatarUrl = freezed,Object? webUrl = freezed,Object? lastActivityAt = freezed,}) {
...
switch (_that) {
case _Project() when $default != null:
return $default(_that.id,_that.name,_that.pathWithNamespace,_that.description,_that.starCount,_that.visibility,_that.defaultBranch,_that.packageRegistryAccessLevel,_that.openIssuesCount,_that.forksCount,_that.avatarUrl,_that.webUrl,_that.lastActivityAt);case _:
  return orElse();
...
class _Project extends Project {
  const _Project({required this.id, required this.name, @JsonKey(name: 'path_with_namespace') required this.pathWithNamespace, this.description, @JsonKey(name: 'star_count') this.starCount = 0, this.visibility, @JsonKey(name: 'default_branch') this.defaultBranch, @JsonKey(name: 'package_registry_access_level') this.packageRegistryAccessLevel, @JsonKey(name: 'open_issues_count') this.openIssuesCount, @JsonKey(name: 'forks_count') this.forksCount, @JsonKey(name: 'avatar_url') this.avatarUrl, @JsonKey(name: 'web_url') this.webUrl, @JsonKey(name: 'last_activity_at') this.lastActivityAt}): super._();
